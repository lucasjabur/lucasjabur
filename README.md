...
<details>
 <summary><h3>👨🏻‍💻 More about me</h3></summary>
    ...
    "Building a proof of concept for an application to locate points of interest within the UFU Hospital de Clínicas (HC-UFU)".
    Our aim is to build an indoor navigation web-app for use within the facilities of the Hospital de Clínicas of the Federal University of Uberlandia.
